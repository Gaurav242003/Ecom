...
export default function Checkout() {
    ...
    return (
        ...
        {myCart.length===0 ?<>
            ...
            <div> <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
              <div className="text-center">
                ...
                <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Add something to your cart!</h1>
        ...
        <>
            {order && <Navigate to={`/order-success/${order.id}`} />}
                            ...
                            <div className="mt-10 space-y-10 ">
                                <ul role="list" className="divide-y divide-gray-100">
                                    {allAddress && allAddress.map((place, index) => (
                                        <div key={index} className="flex justify-between gap-x-6 p-5 border">
